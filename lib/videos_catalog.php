<?php
require_once __DIR__ . '/thumbnail_ladder.php';
 ...
 *   } ] }
 *
 * Caption "file" is a basename under data/captions/ (served via captions-static.php).
 */
...
if (!function_exists('vpc_catalog_collection')) {
     ...
     * `index.php` (home) and `lib/bottom_bar_player_config.php`
