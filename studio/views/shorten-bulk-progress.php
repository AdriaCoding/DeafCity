...
<head>
    ...
    <title>Polir subtítols en massa — Studio</title>
    <style>
...
<body>
    ...
    <main>
        <h2>Polir subtítols en massa</h2>
        <p class="lead">Processant els fitxers. Quan acabi, es descarregarà un ZIP amb tots els subtítols polits.</p>
        ...
        <div id="completed-actions" style="display:none; margin-top:1.5rem;">
            ...
            <p style="margin-top:0.6rem; font-size:0.85rem; color:var(--studio-text-muted);">
                ...
                <a href="?action=shorten-bulk-download" id="manual-download-link" style="color:var(--studio-success-text);">feu clic aquí</a>.
            </p>
        </div>
    </main>
    <script>
    (function () {
        ...
        function triggerDownload() {
            ...
            a.href = '?action=shorten-bulk-download';
        ...
        function poll() {
            fetch('?action=shorten-bulk-status')
