...
// catalog has: 2020-valencia, 2021-mexico, 2023-bilbao, 2023-sao-paulo, 2028-salamanca
...
// catalog has: acudits, anecdotes, endevinalles, malentesos, memories
...
// Check the other two labels (may be ANÈCDOTES and MEMÒRIES — unicode)
...
// AC: Both edition and typology are custom dropdowns (role=listbox already checked above)
// Verify no native <select> — already asserted.

// AC: Option count sanity — 5 editions and 5 typologies present in catalog
// Count data-value attributes in each picker
