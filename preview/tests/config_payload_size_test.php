<?php
// Run: php8.4 preview/tests/config_payload_size_test.php
//
// preview/ renders the whole visible catalog inline in the home page's
// <script type="application/json" class="vpc-config"> block (catalogPlaylist:
// every catalog Video, for client-side filtering — see preview/index.php and
// preview/components/vimeo_caption_player.php). There is no server-side paging or
