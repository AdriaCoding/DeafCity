...
if (!function_exists('preview_asset_url')) {
    /**
     * @param string $relativePath Path relative to the preview/ directory, e.g.
     ...
     *   e.g. '/preview/js/vimeo_playlist_logic.js?v=1735689600'.
     */
    function preview_asset_url($relativePath) {
        ...
        return '/preview/' . $relativePath . '?v=' . $version;
    }
}
