<?php
// Run: php8.4 tests/site_nav_test.php
...
sn_assert($enOpt['href'] === '/about?lang=en', 'English href includes explicit lang=en');
...
sn_assert(preview_append_lang_query('/about', 'en') === '/about?lang=en', 'append lang includes en');
sn_assert(preview_append_lang_query('/about', 'es') === '/about?lang=es', 'append lang adds query');
