 ...
 *
 * Run: php8.4 tests/reset_clears_filters_test.php
 */
...
rcf_assert_contains('loadVideoMaster(playlistIndex, plan.shouldAutoplay, false, true)', $js, 'reset forces reload from cold iframe');
