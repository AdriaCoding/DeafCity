<?php
// Run: php8.4 tests/home_page_test.php
...
assert_contains('/about', $html, 'about nav link');
...
$partPos = strpos($html, '/participants');
...
$catalogJsonPathForTest = dirname(dirname(__FILE__)) . '/data/catalog.json';
...
$catalogJsonPathForEditions = dirname(dirname(__FILE__)) . '/data/catalog.json';
...
assert_contains('/img/help_80dp_007800.svg', $html, 'help uses filled circle SVG');
assert_contains('/img/skip_previous_80dp_007800.svg', $html, 'prev uses borderless skip SVG');
assert_contains('/img/play_circle_80dp_007800.svg', $html, 'play uses filled circle SVG');
assert_contains('/img/skip_next_80dp_007800.svg', $html, 'next uses borderless skip SVG');
assert_contains('/img/replay_circle_filled_80dp_007800.svg', $html, 'reset uses filled replay SVG');
...
assert_contains('/img/hourglass_empty_80dp_ffffff.svg', $html, 'loading sandclock uses inline SVG (no Material font ligature)');
...
assert_contains('/participants', $html, 'Participants nav button in R3');
