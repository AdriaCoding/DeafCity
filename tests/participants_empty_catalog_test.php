<?php
// Run: php8.4 tests/participants_empty_catalog_test.php
//
// When data/catalog.json is missing or invalid, the home page already renders an
// explicit empty state (index.php, player.error.no_playlist) instead of
...
// guard in lib/preview_locale.php (the same pattern used throughout this
