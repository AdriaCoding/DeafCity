 ...
 *     'player' => array(...),          // see lib/bottom_bar_player_config.php
 *   );
 */
...
$iconHelp = preview_asset_url('img/help_80dp_007800.svg');
$iconReset = preview_asset_url('img/replay_circle_filled_80dp_007800.svg');
$iconPrev = preview_asset_url('img/skip_previous_80dp_007800.svg');
$iconPlay = preview_asset_url('img/play_circle_80dp_007800.svg');
$iconPause = preview_asset_url('img/pause_circle_80dp_007800.svg');
$iconHourglass = preview_asset_url('img/hourglass_empty_80dp_ffffff.svg');
$iconNext = preview_asset_url('img/skip_next_80dp_007800.svg');
            ...
            <div class="vpc-control-secondary-l">
                ...
                <?php foreach ($leftNavLinks as $link): ?>
                    <?php if ($link['route'] === 'about'): ?>
                        <?php preview_render_icon_nav_link($link, $iconHelp); ?>
                    <?php else: ?>
...
<?= $transportAriaControlsAttr ?>
            ...
            ><img class="vpc-chrome-icon" src="<?= htmlspecialchars($iconReset, ENT_QUOTES, 'UTF-8') ?>" alt="" width="44" height="44" aria-hidden="true"><span class="vpc-reset-btn__text" data-i18n-text="player.transport.reset_short"><?= htmlspecialchars(preview_t('player.transport.reset_short'), ENT_QUOTES, 'UTF-8') ?></span></button>
            </div>
        </div>
        <div
...
<?= $transportAriaControlsAttr ?>
            ...
            ><img class="vpc-chrome-icon" src="<?= htmlspecialchars($iconPrev, ENT_QUOTES, 'UTF-8') ?>" alt="" width="44" height="44" aria-hidden="true"></button><div class="vpc-control-center"><button
                    type="button"
    ...
    <?= $transportAriaControlsAttr ?>
                    ...
                    data-icon-play="<?= htmlspecialchars($iconPlay, ENT_QUOTES, 'UTF-8') ?>"
                    data-icon-pause="<?= htmlspecialchars($iconPause, ENT_QUOTES, 'UTF-8') ?>"
                ><img class="vpc-chrome-icon" src="<?= htmlspecialchars($iconPlay, ENT_QUOTES, 'UTF-8') ?>" alt="" width="48" height="48" aria-hidden="true"><img class="vpc-play-pause-btn__hourglass" src="<?= htmlspecialchars($iconHourglass, ENT_QUOTES, 'UTF-8') ?>" alt="" width="45" height="45" aria-hidden="true"></button></div><button
                type="button"
...
<?= $transportAriaControlsAttr ?>
            ...
            ><img class="vpc-chrome-icon" src="<?= htmlspecialchars($iconNext, ENT_QUOTES, 'UTF-8') ?>" alt="" width="44" height="44" aria-hidden="true"></button></div>
    </div>
</div>
<?php
