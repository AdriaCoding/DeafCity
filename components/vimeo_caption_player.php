 ...
 *     'iframe_title' => 'Vimeo',
 *     'captions_endpoint' => '/captions-static.php',
 *
...
if (!function_exists('preview_captions_endpoint')) {
    require_once dirname(__DIR__) . '/lib/site_base.php';
}
...
$config = array(
    ...
    'homePath'             => preview_home_path(),
    'localeApiPath'        => preview_locale_api_path(),
    'assetBasePath'        => preview_asset_base_path(),
